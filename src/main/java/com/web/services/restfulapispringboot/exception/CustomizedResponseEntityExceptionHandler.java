package com.web.services.restfulapispringboot.exception;

import com.web.services.restfulapispringboot.user.UserNotFoundException;
...
/*centrally control the Exception messages for API's*/
@ControllerAdvice
@RestController
